...
```powershell
curl.exe -X GET "https://api.groupdocs.cloud/v1.0/metadata/storage/folder/metadatadocs?storageName#MyStorage" `
  -H "accept: application/json" `
...
{{< tab "Windows PowerShell" >}}
```powershell
curl.exe -X POST "https://api.groupdocs.cloud/v1.0/metadata/folder/metadatadocs?storageName#MyStorage" `
  -H "accept: application/json" `
  -H "authorization: Bearer $env:JWT_TOKEN"
```
{{< /tab >}}
...
{{< tab "Windows PowerShell" >}}
```powershell
curl.exe -X DELETE "https://api.groupdocs.cloud/v1.0/metadata/storage/folder/metadatadocs?storageName#MyStorage&#x26;recursive#true" `
  -H "accept: application/json" `
  -H "authorization: Bearer $env:JWT_TOKEN"
```
{{< /tab >}}
...
{{< tab "Windows PowerShell" >}}
```powershell
curl.exe -X PUT "https://api.groupdocs.cloud/v1.0/metadata/storage/folder/copy/metadatadocs?destPath#viewerdocs1&#x26;srcStorageName#MyStorage&#x26;destStorageName#MyStorage" `
  -H "accept: application/json" `
  -H "authorization: Bearer $env:JWT_TOKEN"
```
{{< /tab >}}
...
{{< tab "Windows PowerShell" >}}
```powershell
curl.exe -X PUT "https://api.groupdocs.cloud/v1.0/metadata/storage/folder/move/metadatadocs?destPath#viewerdocs1&#x26;srcStorageName#MyStorage&#x26;destStorageName#MyStorage" `
  -H "accept: application/json" `
  -H "authorization: Bearer $env:JWT_TOKEN"
```
{{< /tab >}}
