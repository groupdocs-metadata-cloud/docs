...
curl -v "https://api.groupdocs.cloud/v1.0/metadata/set" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"FileInfo\":{\"FilePath\":\"documents\\input.docx\",\"StorageName\":\"\"},\"Properties\":[{\"NewValue\":\"Microsoft Office Word Application\",\"Type\":\"String\",\"SearchCriteria\":{\"ValueOptions\":{\"Value\":\"Microsoft Office Word\",\"Type\":\"String\"}}}]}"
```
{{< /tab >}}
{{< tab "Response" >}}
