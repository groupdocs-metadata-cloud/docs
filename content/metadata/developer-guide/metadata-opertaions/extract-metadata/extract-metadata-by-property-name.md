...
# Kindly place Client Id in $CLIENT_ID and Client Secret in $CLIENT_SECRET arguments.
...
# First get JSON Web Token
# Please get your Client Id and Client Secret from https://dashboard.groupdocs.cloud/applications.
# Kindly place Client Id in $env:CLIENT_ID and Client Secret in $env:CLIENT_SECRET arguments.
...
curl -v "https://api.groupdocs.cloud/v1.0/metadata" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"FileInfo\":{\"FilePath\":\"documents\\input.docx\",\"StorageName\":\"\"},\"SearchCriteria\":{\"NameOptions\":{\"Value\":\"Date\"}}}"
```
