...
# cURL example to add metadata to a document
...
curl -v "https://api.groupdocs.cloud/v1.0/metadata/add" ^
  ...
  -H "Accept: application/json" ^
  -H "Authorization: Bearer %JWT_TOKEN%" ^
  -d "{\"FileInfo\":{\"FilePath\":\"documents\\input.docx\",\"StorageName\":\"\"},\"Properties\":[{\"Value\":\"02-12-2020 04:41:10\",\"Type\":\"DateTime\",\"SearchCriteria\":{\"NameOptions\":{\"Value\":\"Lastprinted\",\"MatchOptions\":{\"ExactPhrase\":true}}}}]}"
```
